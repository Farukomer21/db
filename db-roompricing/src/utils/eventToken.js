...
const PublicObjectEvents = {
  roomPrice: [
    "db-roompricing-service-roomprice-created",
    "db-roompricing-service-roomprice-updated",
    "db-roompricing-service-roomprice-deleted",
    "db-roompricing-service-roomprice-retrived",
    "db-roompricing-service-roomprices-listed",
  ],
};
