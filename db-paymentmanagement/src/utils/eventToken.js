...
const PublicObjectEvents = {
  payment: [
    "db-paymentmanagement-service-payment-created",
    "db-paymentmanagement-service-payment-updated",
    "db-paymentmanagement-service-payment-deleted",
    "db-paymentmanagement-service-payment-retrived",
    "db-paymentmanagement-service-payments-listed",
  ],
};
