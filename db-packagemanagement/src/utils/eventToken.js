...
const PublicObjectEvents = {
  package_: [
    "db-packagemanagement-service-package_-created",
    "db-packagemanagement-service-package_-updated",
    "db-packagemanagement-service-package_-retrived",
    "db-packagemanagement-service-package_-deleted",
    "db-packagemanagement-service-packages-listed",
  ],
};
