...
describe("CreateFeedbackGuestMcpController", () => {
  let factory;
  ...
  beforeEach(() => {
    ...
    factory = proxyquire(
      "../../../src/controllers-layer/mcp-layer/main/feedback/create-feedbackguest-api.js",
      {
        apiLayer: { CreateFeedbackGuestManager: ManagerStub },
  ...
  it("factory should return correct metadata", () => {
    ...
    expect(result.name).to.equal("createFeedbackGuest");
