...
describe("CreateFeedbackGuestRestController", () => {
  let createFeedbackGuest;
  ...
  beforeEach(() => {
    ...
    createFeedbackGuest = proxyquire(
      "../../../src/controllers-layer/rest-layer/main/feedback/create-feedbackguest-api.js",
      {
        serviceCommon: {
          HexaLogTypes: {},
        ...
        apiLayer: {
          CreateFeedbackGuestManager: sinon.stub(),
        },
  ...
  it("should create instance and call processRequest", async () => {
    await createFeedbackGuest(req, res, next);
