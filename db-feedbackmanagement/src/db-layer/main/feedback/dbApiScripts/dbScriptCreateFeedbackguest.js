...
// This script is called from the CreateFeedbackGuestManager
...
const dbScriptCreateFeedbackguest = async (apiManager) => {
  ...
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptCreateFeedbackguest",
      {
        whereClause: null,
...
module.exports = dbScriptCreateFeedbackguest;
