...
const PublicObjectEvents = {
  feedback: [
    "db-feedbackmanagement-service-feedbackguest-created",
    "db-feedbackmanagement-service-feedback-retrived",
    "db-feedbackmanagement-service-feedback-updated",
    "db-feedbackmanagement-service-feedback-deleted",
    "db-feedbackmanagement-service-feedbacks-listed",
  ],
};
