...
const PublicObjectEvents = {
  personnel: [
    "db-personnelmanagement-service-personnel-created",
    "db-personnelmanagement-service-personnel-updated",
    "db-personnelmanagement-service-personnel-deleted",
    "db-personnelmanagement-service-personnel-retrived",
    "db-personnelmanagement-service-personnels-listed",
  ],
};
