...
// This script is called from the ListPersonnelsManager
...
const dbScriptListPersonnels = async (apiManager) => {
  ...
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptListPersonnels",
      {
...
module.exports = dbScriptListPersonnels;
