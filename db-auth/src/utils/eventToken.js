...
const PrivateObjectEvents = {
  user: [
    "db-auth-service-user-retrived",
    "db-auth-service-user-updated",
    "db-auth-service-user-registered",
    "db-auth-service-user-deleted",
    "db-auth-service-users-listed",
    "db-auth-service-userrole-updated",
    "db-auth-service-userpassword-updated",
    "db-auth-service-briefuser-retrived",
  ],
};
