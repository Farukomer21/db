...
const protoFile = path.join(
  ...
  "grpc-layer",
  "proto",
  "packageReservationMapping.proto",
);
...
const packageReservationMappingPackage = grpcObject.packageReservationMapping;

const server = new grpc.Server();

function helloMessage(call, callback) {
  callback(null, {
    hello: "hello, this is db-packagereservationmapping-service",
  });
}
...
server.addService(
  packageReservationMappingPackage.packageReservationMappingService.service,
  {
    helloMessage,
    ...sessionRouter,
  },
