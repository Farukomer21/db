...
// This script is called from the GetPackageReservationManager
...
const dbScriptGetPackagereservation = async (apiManager) => {
  ...
  try {
    ...
    let rowData = await PackageReservation.findOne(options);
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptGetPackagereservation",
      {
...
module.exports = dbScriptGetPackagereservation;
