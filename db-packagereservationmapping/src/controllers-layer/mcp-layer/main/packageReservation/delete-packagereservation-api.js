...
class DeletePackageReservationMcpController extends PackageReservationMappingMcpController {
  constructor(params) {
    super("deletePackageReservation", "deletepackagereservation", params);
    this.dataName = "packageReservation";
    this.crudType = "delete";
  }

  createApiManager() {
    return new DeletePackageReservationManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  return {
    ...
    parameters: DeletePackageReservationMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      console.log("Mcp Request Received", mcpParams);
      mcpParams.headers = headers;
      const controller = new DeletePackageReservationMcpController(mcpParams);
      try {
        const result = await controller.processRequest();
        //return DeletePackageReservationMcpController.getOutputSchema().parse(result);
