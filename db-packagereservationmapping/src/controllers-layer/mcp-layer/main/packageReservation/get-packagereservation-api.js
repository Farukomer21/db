...
class GetPackageReservationMcpController extends PackageReservationMappingMcpController {
  constructor(params) {
    super("getPackageReservation", "getpackagereservation", params);
    this.dataName = "packageReservation";
    this.crudType = "get";
  }

  createApiManager() {
    return new GetPackageReservationManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  return {
    ...
    parameters: GetPackageReservationMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      console.log("Mcp Request Received", mcpParams);
      mcpParams.headers = headers;
      const controller = new GetPackageReservationMcpController(mcpParams);
      try {
        const result = await controller.processRequest();
        //return GetPackageReservationMcpController.getOutputSchema().parse(result);
