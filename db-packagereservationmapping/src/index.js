...
console.log("Starting db-packagereservationmapping-service service...");
...
const start = async () => {
  process.title = "node-db-packagereservationmapping-service";
  ...
  try {
    ...
    await setRedisData(
      "db-packagereservationmapping-service:start",
      today.toUTCString(),
    );
    console.log(
      "Service start datetime is written to Redis key db-packagereservationmapping-service:start",
      today.toUTCString(),
    );
  } catch (err) {
  ...
  console.log(
    "db-packagereservationmapping-service is listening HTTP/REST port " +
...
/* starting the server db-packagereservationmapping-service .... */
start();
