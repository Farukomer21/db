...
describe("CreatePackageReservationMcpController", () => {
  let factory;
  ...
  beforeEach(() => {
    ...
    factory = proxyquire(
      "../../../src/controllers-layer/mcp-layer/main/packageReservation/create-packagereservation-api.js",
      {
        apiLayer: { CreatePackageReservationManager: ManagerStub },
        "../../PackageReservationMappingServiceMcpController": class {
  ...
  it("factory should return correct metadata", () => {
    ...
    expect(result.name).to.equal("createPackageReservation");
