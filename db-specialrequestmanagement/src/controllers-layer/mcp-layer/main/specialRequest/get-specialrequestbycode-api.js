...
class GetSpecialRequestByCodeMcpController extends SpecialRequestManagementMcpController {
  constructor(params) {
    super("getSpecialRequestByCode", "getspecialrequestbycode", params);
    this.dataName = "specialRequest";
    this.crudType = "get";
  }

  createApiManager() {
    return new GetSpecialRequestByCodeManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  return {
    ...
    parameters: GetSpecialRequestByCodeMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      console.log("Mcp Request Received", mcpParams);
      mcpParams.headers = headers;
      const controller = new GetSpecialRequestByCodeMcpController(mcpParams);
      try {
        const result = await controller.processRequest();
        //return GetSpecialRequestByCodeMcpController.getOutputSchema().parse(result);
