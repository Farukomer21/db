...
class CreateSpecialRequestPublicMcpController extends SpecialRequestManagementMcpController {
  constructor(params) {
    super("createSpecialRequestPublic", "createspecialrequestpublic", params);
    this.dataName = "specialRequest";
    this.crudType = "create";
  }

  createApiManager() {
    return new CreateSpecialRequestPublicManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  return {
    ...
    parameters: CreateSpecialRequestPublicMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      console.log("Mcp Request Received", mcpParams);
      mcpParams.headers = headers;
      const controller = new CreateSpecialRequestPublicMcpController(mcpParams);
      try {
        const result = await controller.processRequest();
        //return CreateSpecialRequestPublicMcpController.getOutputSchema().parse(result);
