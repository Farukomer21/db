...
class ListSpecialRequestsByCodeMcpController extends SpecialRequestManagementMcpController {
  constructor(params) {
    super("listSpecialRequestsByCode", "listspecialrequestsbycode", params);
    this.dataName = "specialRequests";
    this.crudType = "list";
  }

  createApiManager() {
    return new ListSpecialRequestsByCodeManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  return {
    ...
    parameters: ListSpecialRequestsByCodeMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      console.log("Mcp Request Received", mcpParams);
      mcpParams.headers = headers;
      const controller = new ListSpecialRequestsByCodeMcpController(mcpParams);
      try {
        const result = await controller.processRequest();
        //return ListSpecialRequestsByCodeMcpController.getOutputSchema().parse(result);
