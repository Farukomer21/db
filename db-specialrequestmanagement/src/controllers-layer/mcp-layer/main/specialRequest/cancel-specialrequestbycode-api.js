...
class CancelSpecialRequestByCodeMcpController extends SpecialRequestManagementMcpController {
  constructor(params) {
    super("cancelSpecialRequestByCode", "cancelspecialrequestbycode", params);
    this.dataName = "specialRequest";
    this.crudType = "update";
  }

  createApiManager() {
    return new CancelSpecialRequestByCodeManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  return {
    ...
    parameters: CancelSpecialRequestByCodeMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      console.log("Mcp Request Received", mcpParams);
      mcpParams.headers = headers;
      const controller = new CancelSpecialRequestByCodeMcpController(mcpParams);
      try {
        const result = await controller.processRequest();
        //return CancelSpecialRequestByCodeMcpController.getOutputSchema().parse(result);
