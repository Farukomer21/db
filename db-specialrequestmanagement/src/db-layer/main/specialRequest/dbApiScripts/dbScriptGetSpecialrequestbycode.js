...
// This script is called from the GetSpecialRequestByCodeManager
...
const dbScriptGetSpecialrequestbycode = async (apiManager) => {
  ...
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptGetSpecialrequestbycode",
      {
...
module.exports = dbScriptGetSpecialrequestbycode;
