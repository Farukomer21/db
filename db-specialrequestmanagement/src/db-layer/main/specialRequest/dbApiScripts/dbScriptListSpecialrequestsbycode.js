...
// This script is called from the ListSpecialRequestsByCodeManager
...
const dbScriptListSpecialrequestsbycode = async (apiManager) => {
  ...
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptListSpecialrequestsbycode",
      {
...
module.exports = dbScriptListSpecialrequestsbycode;
