...
// This script is called from the CreateSpecialRequestPublicManager
...
const dbScriptCreateSpecialrequestpublic = async (apiManager) => {
  ...
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptCreateSpecialrequestpublic",
      {
        whereClause: null,
...
module.exports = dbScriptCreateSpecialrequestpublic;
