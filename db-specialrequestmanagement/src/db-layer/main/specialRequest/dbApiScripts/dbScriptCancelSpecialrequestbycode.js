...
// This script is called from the CancelSpecialRequestByCodeManager
...
const dbScriptCancelSpecialrequestbycode = async (apiManager) => {
  ...
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptCancelSpecialrequestbycode",
      {
...
module.exports = dbScriptCancelSpecialrequestbycode;
