...
console.log("Starting db-specialrequestmanagement-service service...");
...
const start = async () => {
  process.title = "node-db-specialrequestmanagement-service";
  ...
  try {
    ...
    await setRedisData(
      "db-specialrequestmanagement-service:start",
      today.toUTCString(),
    );
    console.log(
      "Service start datetime is written to Redis key db-specialrequestmanagement-service:start",
      today.toUTCString(),
    );
  } catch (err) {
  ...
  console.log(
    "db-specialrequestmanagement-service is listening HTTP/REST port " +
...
/* starting the server db-specialrequestmanagement-service .... */
start();
