...
console.log("Starting db-reservationmanagement-service service...");
...
const start = async () => {
  process.title = "node-db-reservationmanagement-service";
  ...
  try {
    ...
    await setRedisData(
      "db-reservationmanagement-service:start",
      today.toUTCString(),
    );
    console.log(
      "Service start datetime is written to Redis key db-reservationmanagement-service:start",
      today.toUTCString(),
    );
  } catch (err) {
  ...
  console.log(
    "db-reservationmanagement-service is listening HTTP/REST port " +
...
/* starting the server db-reservationmanagement-service .... */
start();
