...
class UpdateReservationByCodeMcpController extends ReservationManagementMcpController {
  constructor(params) {
    super("updateReservationByCode", "updatereservationbycode", params);
    this.dataName = "reservation";
    this.crudType = "update";
  }

  createApiManager() {
    return new UpdateReservationByCodeManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  return {
    ...
    parameters: UpdateReservationByCodeMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      console.log("Mcp Request Received", mcpParams);
      mcpParams.headers = headers;
      const controller = new UpdateReservationByCodeMcpController(mcpParams);
      try {
        const result = await controller.processRequest();
        //return UpdateReservationByCodeMcpController.getOutputSchema().parse(result);
