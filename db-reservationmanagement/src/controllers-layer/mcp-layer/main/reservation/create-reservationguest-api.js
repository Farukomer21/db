...
class CreateReservationGuestMcpController extends ReservationManagementMcpController {
  constructor(params) {
    super("createReservationGuest", "createreservationguest", params);
    this.dataName = "reservation";
    this.crudType = "create";
  }

  createApiManager() {
    return new CreateReservationGuestManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  return {
    ...
    parameters: CreateReservationGuestMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      console.log("Mcp Request Received", mcpParams);
      mcpParams.headers = headers;
      const controller = new CreateReservationGuestMcpController(mcpParams);
      try {
        const result = await controller.processRequest();
        //return CreateReservationGuestMcpController.getOutputSchema().parse(result);
