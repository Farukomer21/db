...
module.exports = {
  ...
  dbScriptCreateReservationguest:
    reservationFunctions.dbScriptCreateReservationguest,
  dbScriptConfirmReservationpayment:
    reservationFunctions.dbScriptConfirmReservationpayment,
  dbScriptGetReservationbycode:
    reservationFunctions.dbScriptGetReservationbycode,
  dbScriptUpdateReservationbycode:
    reservationFunctions.dbScriptUpdateReservationbycode,
