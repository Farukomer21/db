...
// This script is called from the UpdateReservationByCodeManager
...
const dbScriptUpdateReservationbycode = async (apiManager) => {
  ...
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptUpdateReservationbycode",
      {
...
module.exports = dbScriptUpdateReservationbycode;
