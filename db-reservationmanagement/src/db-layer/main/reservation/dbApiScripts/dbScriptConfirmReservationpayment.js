...
// This script is called from the ConfirmReservationPaymentManager
...
const dbScriptConfirmReservationpayment = async (apiManager) => {
  ...
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptConfirmReservationpayment",
      {
...
module.exports = dbScriptConfirmReservationpayment;
