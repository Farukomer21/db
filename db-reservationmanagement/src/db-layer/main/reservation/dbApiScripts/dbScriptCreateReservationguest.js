...
// This script is called from the CreateReservationGuestManager
...
async function checkForUniqueIndex(dataClause) {
  ...
  if (dbDoc) {
    indexName = "idx_reservationCode_unique";
...
const dbScriptCreateReservationguest = async (apiManager) => {
  ...
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptCreateReservationguest",
      {
        whereClause: null,
...
module.exports = dbScriptCreateReservationguest;
