...
// Publisher class for getReservation api
...
// Publisher class for createReservationGuest api
const { ReservationguestCreatedTopic } = require("./topics");
class ReservationguestCreatedPublisher extends ServicePublisher {
  constructor(reservationguest, session, requestId) {
    super(ReservationguestCreatedTopic, reservationguest, session, requestId);
  }

  static async Publish(reservationguest, session, requestId) {
    const _publisher = new ReservationguestCreatedPublisher(
      reservationguest,
      session,
      requestId,
    );
...
// Publisher class for confirmReservationPayment api
const { ReservationpaymentConfirmedTopic } = require("./topics");
class ReservationpaymentConfirmedPublisher extends ServicePublisher {
  constructor(reservationpayment, session, requestId) {
    super(
  ...
  static async Publish(reservationpayment, session, requestId) {
    const _publisher = new ReservationpaymentConfirmedPublisher(
      reservationpayment,
      session,
      requestId,
    );
...
// Publisher class for updateReservationByCode api
const { ReservationbycodeUpdatedTopic } = require("./topics");
class ReservationbycodeUpdatedPublisher extends ServicePublisher {
  constructor(reservationbycode, session, requestId) {
    super(ReservationbycodeUpdatedTopic, reservationbycode, session, requestId);
  }

  static async Publish(reservationbycode, session, requestId) {
    const _publisher = new ReservationbycodeUpdatedPublisher(
      reservationbycode,
      session,
      requestId,
    );
...
module.exports = {
  ...
  ReservationpaymentConfirmedPublisher,
  ReservationbycodeRetrivedPublisher,
  ReservationbycodeUpdatedPublisher,
