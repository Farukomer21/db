...
const PublicObjectEvents = {
  room: [
    "db-roominventory-service-room-created",
    "db-roominventory-service-room-updated",
    "db-roominventory-service-room-retrived",
    "db-roominventory-service-room-deleted",
    "db-roominventory-service-rooms-listed",
    "db-roominventory-service-availablerooms-listed",
  ],
};
