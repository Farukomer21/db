...
// This script is called from the ListAvailableRoomsManager
...
const dbScriptListAvailablerooms = async (apiManager) => {
  ...
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptListAvailablerooms",
      {
...
module.exports = dbScriptListAvailablerooms;
