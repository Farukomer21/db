...
describe("UpdateRoomMcpController", () => {
  let factory;
  ...
  beforeEach(() => {
    ...
    factory = proxyquire(
      "../../../src/controllers-layer/mcp-layer/main/room/update-room-api.js",
      {
        apiLayer: { UpdateRoomManager: ManagerStub },
  ...
  it("factory should return correct metadata", () => {
    ...
    expect(result.name).to.equal("updateRoom");
