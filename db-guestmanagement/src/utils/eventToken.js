...
const PublicObjectEvents = {
  guest: [
    "db-guestmanagement-service-guest-created",
    "db-guestmanagement-service-guest-updated",
    "db-guestmanagement-service-guest-retrived",
    "db-guestmanagement-service-guest-deleted",
    "db-guestmanagement-service-guests-listed",
  ],
};
