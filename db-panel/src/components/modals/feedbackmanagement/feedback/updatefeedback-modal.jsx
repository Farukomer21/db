...
export default function ({ openDialog, selectedFeedback }) {
  ...
  const requestParams = [
    {
      name: "guestName",
      value: selectedFeedback?.guestName ?? "",
      type: "String",
    },

    { name: "rating", value: selectedFeedback?.rating ?? "", type: "Integer" },

    { name: "comment", value: selectedFeedback?.comment ?? "", type: "Text" },
  ];

  const defaultValues = {
    guestName: selectedFeedback?.guestName ?? "",
