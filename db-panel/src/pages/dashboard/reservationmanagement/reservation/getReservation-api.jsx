...
import { useReservationManagementGetReservation } from "src/actions/reservationManagement";

import { JsonResponse } from "../../../../components/json-response";
import { TableResponse } from "../../../../components/table-response";

export default function ReservationManagementGetReservationApiPage() {
  ...
  const { reservation, reservationLoading, reservationError } =
    useReservationManagementGetReservation(submittedReservationId);
