...
import { useReservationManagementGetReservationByCode } from "src/actions/reservationManagement";

import { JsonResponse } from "../../../../components/json-response";
import { TableResponse } from "../../../../components/table-response";

export default function ReservationManagementGetReservationByCodeApiPage() {
  ...
  const { reservation, reservationLoading, reservationError } =
    useReservationManagementGetReservationByCode(submittedReservationId);

  const handleGetReservationbycode = () => {
    ...
    <>
      <Box marginY="2rem">
        ...
        <Box component="div" gap="1rem" display="flex" key="0">
          ...
          <Button
            variant="outlined"
            onClick={handleGetReservationbycode}
