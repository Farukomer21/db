...
import { useRoomInventoryListAvailableRooms } from "src/actions/roomInventory";

export default function RoomInventoryListAvailableRoomsApiPage() {
  const { searchResults: options, searchLoading: loading } =
    useRoomInventoryListAvailableRooms();
