...
export default function PaymentManagementCreatePaymentApiPage() {
  ...
  const onSubmit = handleSubmit(async (data) => {
    try {
      const response = await paymentManagementAxios.post(
        paymentManagementEndpoints.payment.createPayment,
        data,
      );
      setError(null);
