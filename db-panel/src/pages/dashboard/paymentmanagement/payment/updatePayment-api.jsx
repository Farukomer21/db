...
const requestParams = [
  ...
  { name: "gatewayReference", value: "", type: "String" },

  { name: "processedAt", value: "", type: "Date" },
];
...
export default function PaymentManagementUpdatePaymentApiPage() {
  ...
  const onSubmit = handleSubmit(async (data) => {
    try {
      ...
      setUpdatedPayment(response.data.payment);
    } catch (ex) {
      console.error(ex);
      setError(ex);
    }
