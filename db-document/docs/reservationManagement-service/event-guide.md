...
**Event topic**: `db-reservationmanagement-service-dbevent-reservation-created`
...
**Event payload**: 
```json
{"id":"ID","_owner":"ID","guestId":"ID","roomId":"ID","checkInDate":"Date","checkOutDate":"Date","reservationCode":"String","packages":"ID","specialRequests":"ID","paymentId":"ID","status":"Enum","status_":"String","numGuests":"Integer","totalPrice":"Double","notes":"Text","isActive":true,"recordVersion":"Integer","createdAt":"Date","updatedAt":"Date"}
```  
## DbEvent reservation-updated

**Event topic**: `db-reservationmanagement-service-dbevent-reservation-updated`
...
```json
{
old_reservation:{"id":"ID","_owner":"ID","guestId":"ID","roomId":"ID","checkInDate":"Date","checkOutDate":"Date","reservationCode":"String","packages":"ID","specialRequests":"ID","paymentId":"ID","status":"Enum","status_":"String","numGuests":"Integer","totalPrice":"Double","notes":"Text","isActive":true,"recordVersion":"Integer","createdAt":"Date","updatedAt":"Date"},
reservation:{"id":"ID","_owner":"ID","guestId":"ID","roomId":"ID","checkInDate":"Date","checkOutDate":"Date","reservationCode":"String","packages":"ID","specialRequests":"ID","paymentId":"ID","status":"Enum","status_":"String","numGuests":"Integer","totalPrice":"Double","notes":"Text","isActive":true,"recordVersion":"Integer","createdAt":"Date","updatedAt":"Date"},
}
``` 
## DbEvent reservation-deleted

**Event topic**: `db-reservationmanagement-service-dbevent-reservation-deleted`
...
**Event payload**: 
```json
{"id":"ID","_owner":"ID","guestId":"ID","roomId":"ID","checkInDate":"Date","checkOutDate":"Date","reservationCode":"String","packages":"ID","specialRequests":"ID","paymentId":"ID","status":"Enum","status_":"String","numGuests":"Integer","totalPrice":"Double","notes":"Text","isActive":false,"recordVersion":"Integer","createdAt":"Date","updatedAt":"Date"}
```  
...
**Event topic**: `elastic-index-db_reservation-created`
...
**Event topic**: `elastic-index-db_reservation-deleted`
...
**Event topic**: `elastic-index-db_reservation-extended`
...
**Event topic** : `db-reservationmanagement-service-reservation-created`
...
**Event topic** : `db-reservationmanagement-service-reservation-updated`
...
**Event topic** : `db-reservationmanagement-service-reservation-retrived`
...
**Event topic** : `db-reservationmanagement-service-reservation-deleted`
...
**Event topic** : `db-reservationmanagement-service-reservations-listed`
...
```  
## Route Event reservationguest-created

**Event topic** : `db-reservationmanagement-service-reservationguest-created`
...
{"status":"OK","statusCode":"201","elapsedMs":126,"ssoTime":120,"source":"db","cacheKey":"hexCode","userId":"ID","sessionId":"ID","requestId":"ID","dataName":"reservation","method":"POST","action":"create","appVersion":"Version","rowCount":1,"reservation":{"id":"ID","_owner":"ID","guestId":"ID","roomId":"ID","checkInDate":"Date","checkOutDate":"Date","reservationCode":"String","packages":"ID","specialRequests":"ID","paymentId":"ID","status":"Enum","status_":"String","numGuests":"Integer","totalPrice":"Double","notes":"Text","isActive":true,"recordVersion":"Integer","createdAt":"Date","updatedAt":"Date"}}
```  
## Route Event reservationpayment-confirmed

**Event topic** : `db-reservationmanagement-service-reservationpayment-confirmed`
...
**Event topic** : `db-reservationmanagement-service-reservationbycode-retrived`
...
{"status":"OK","statusCode":"200","elapsedMs":126,"ssoTime":120,"source":"db","cacheKey":"hexCode","userId":"ID","sessionId":"ID","requestId":"ID","dataName":"reservation","method":"GET","action":"get","appVersion":"Version","rowCount":1,"reservation":{"id":"ID","_owner":"ID","guestId":"ID","roomId":"ID","checkInDate":"Date","checkOutDate":"Date","reservationCode":"String","packages":"ID","specialRequests":"ID","paymentId":"ID","status":"Enum","status_":"String","numGuests":"Integer","totalPrice":"Double","notes":"Text","isActive":true,"recordVersion":"Integer","createdAt":"Date","updatedAt":"Date"}}
```  
## Route Event reservationbycode-updated

**Event topic** : `db-reservationmanagement-service-reservationbycode-updated`
...
**Event topic** : `db-reservationmanagement-service-reservationbycode-canceled`
