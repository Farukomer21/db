...
*Resource Definition* : Hotel reservation record linking guest, room, payment, packages, special requests, and a secure reservationCode for guest access. Used for both staff and guest workflows.
*Reservation Resource Properties* 
| Name | Type | Required | Default | Definition | 
| ---- | ---- | -------- | ------- | ---------- |
| **guestId** | ID |  |  | *Reference to guest who made this reservation.* |
| **roomId** | ID |  |  | *Reference to the hotel room for this reservation.* |
| **checkInDate** | Date |  |  | *Check-in date for the reservation.* |
| **checkOutDate** | Date |  |  | *Check-out date for the reservation.* |
| **reservationCode** | String |  |  | *Unique, cryptographically secure reservation code for guest access. Null until payment is confirmed.* |
| **packages** | ID |  |  | *Array of package IDs associated to this reservation (maps to packageReservationMapping).* |
| **specialRequests** | ID |  |  | *Array of specialRequest IDs associated with this reservation.* |
| **paymentId** | ID |  |  | *Reference to the payment record for this reservation.* |
| **status** | Enum |  |  | *Reservation status: pending=not yet paid, confirmed=paid, canceled, completed=after stay.* |
| **numGuests** | Integer |  |  | *Number of guests for this reservation.* |
| **totalPrice** | Double |  |  | *Total price for the reservation (rooms + packages).* |
| **notes** | Text |  |  | *Internal notes, only for staff eyes (not sent to guests/public).* |
#### Enum Properties
...
*API Definition* : Staff API to create new reservation record with any status. Internal use only.
...
*API Definition* : Staff API to update any reservation field. Internal use only.
...
### Get Reservation API
*API Definition* : Staff API to get reservation by ID. Internal use only.
...
*API Definition* : Staff API to delete reservation by ID (soft-delete enabled). Internal use only.
...
*API Definition* : Staff API to list reservations for hotel operations. Internal use only.
...
*API Definition* : Guest-facing API. Create a reservation in &#39;pending&#39; status (pre-payment, no code yet), with guest, dates, room, packages, and optional special requests.

*API Crud Type* : create

*Default access route* : *POST* `/v1/reservationguest`
...
*API Definition* : Guest API. After external payment is successful, mark reservation as confirmed, generate &amp; store reservationCode.

*API Crud Type* : update

*Default access route* : *PATCH* `/v1/confirmreservationpayment/:reservationId`
...
*API Definition* : Guest self-service. Retrieve reservation by reservationCode (no auth).

*API Crud Type* : get

*Default access route* : *GET* `/v1/reservationbycode/:reservationId`
...
*API Definition* : Guest self-service. Update reservation by reservationCode. Only if status allows; restrict to editable fields for guest.

*API Crud Type* : update

*Default access route* : *PATCH* `/v1/reservationbycode/:reservationId`
...
*API Definition* : Guest self-service. Cancel reservation using reservationCode. Only possible if not already canceled or completed.

*API Crud Type* : update

*Default access route* : *PATCH* `/v1/cancelreservationbycode/:reservationId`
