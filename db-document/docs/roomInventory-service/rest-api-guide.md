...
*Resource Definition* : Represents a room in the hotel. Includes identifiers, type, status, amenities, and details needed for room search and assignment.
*Room Resource Properties* 
| Name | Type | Required | Default | Definition | 
| ---- | ---- | -------- | ------- | ---------- |
| **roomNumber** | String |  |  | *Unique number or code for the room (e.g., 101, B12).* |
| **floor** | Integer |  |  | *Floor number where room is located.* |
| **type** | Enum |  |  | *Room type (e.g., single, double, suite).* |
| **capacity** | Integer |  |  | *Maximum number of guests room can accommodate.* |
| **bedType** | String |  |  | *Type of beds (e.g., queen, twin, king).* |
| **amenities** | String |  |  | *Array of amenity descriptions (e.g., Wi-Fi, TV, minibar).* |
| **status** | Enum |  |  | *Room status (available, occupied, under maintenance).* |
| **description** | Text |  |  | *Detailed textual description of the room.* |
...
## Business Api
### Update Room API
*API Definition* : Updates details of a room. Only intended for staff interface.

*API Crud Type* : update

*Default access route* : *PATCH* `/v1/rooms/:roomId`
...
### Get Room API
*API Definition* : Retrieve a room by ID. Staff only; not exposed to guests directly.

*API Crud Type* : get

*Default access route* : *GET* `/v1/rooms/:roomId`
...
### Delete Room API
*API Definition* : Deletes a room from the inventory (soft delete). Staff only.

*API Crud Type* : delete

*Default access route* : *DELETE* `/v1/rooms/:roomId`
...
### List Rooms API
*API Definition* : Lists all rooms with optional filters (public and staff).

*API Crud Type* : list

*Default access route* : *GET* `/v1/rooms`
...
*API Definition* : Lists available rooms for booking. Public API for reservation selection; allows filtering by type, capacity, floor, and more. Only rooms with &#39;available&#39; status are returned.

*API Crud Type* : list

*Default access route* : *GET* `/v1/availablerooms`
...
> For a detailed description of the `` api with its internal and inter-service logic please refer to the [Business API Specification Document For List Availablerooms](businessApi/listAvailableRooms).
